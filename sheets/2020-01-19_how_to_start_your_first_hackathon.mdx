...
3. [Matthew](https://matthewstanciu.me/) ran [Windy City Hacks](https://2019.windyhacks.com/), which I co-organized, Chicago, 8 organizers, 155 people, June 2019
...
- You need to write a prospectus. This is 2-3 page PDF document explaining the problem, how your event solves the problem, & how a company can contribute to your event.
  ...
  - Here’s [Hack Pennsylvania’s](https://2019.hackpenn.com/prospectus.pdf) & [Windy City Hacks’](https://2019-site.windyhacks.com/prospectus.pdf) for reference. Feel free to use them as inspiration, but please don’t copy. Also, your event is different!
...
1. Get on [HCB](https://hackclub.com/fiscal-sponsorship/) on day one.
...
My primary advice here is to **plan the experience**, end-to-end, _from the attendee point of view_. Before the event, what emails should people get, when? (I used but no longer recommend [Sendy](https://sendy.co/), available through HCB. I now recommend [Buttondown](https://buttondown.email/).) What will check-in look like? Opening ceremony? How are mentors available? When are workshops? How will judging work? How are you deciding prizes? What’s happening at closing ceremony? Are we taking photos, posting on social media? (Does that mean a photographer?)
...
- I can’t recommend [HCB](https://hackclub.com/fiscal-sponsorship/) enough
- Watch [Meginar](https://youtu.be/tOmXzA4reTY) for sponsorship info
- If you want to organize an event & have questions, send me a [DM on Twitter](https://twitter.com/lachlanjc) or the Slack (or [an email](mailto:lachlanjc@hey.com), but I might be slow to respond)
