...
- Researched coal ash, then started learning some Blender 3D modeling, and used Unity for the first time to put the models in AR
...
There’s a few, significant facts that influence my approach:
