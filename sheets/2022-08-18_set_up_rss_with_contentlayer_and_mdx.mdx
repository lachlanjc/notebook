...
I recently [switched](https://github.com/lachlanjc/notebook/commit/31a6c807a56b52e065bb60878c3c1890461fb3b0) this site off Gatsby (finally!) to Next.js & [Contentlayer](https://www.contentlayer.dev). Afterwards, I wanted to get an RSS feed set up, a long-overdue feature since I’m a heavy RSS reader personally.
...
Contentlayer provided easy access to the MDX source text, then with a quick & dirty combination with [this (untyped/unmaintained) Remark plugin](https://www.npmjs.com/package/remark-mdx-to-plain-text) from Jared Sumner, & got my function generating post previews immediately:
...
The feed looked fine as XML, so after a quick test with an RSS client[^1] I shipped it.
