...
One nice touch is that the service supports a dark mode, which you can automatically use for special posts. On Notebook, that’s my non-dated pages like [Tools](https://notebook.lachlanjc.com/tools/), and on IMA, I made midterm & final projects use dark mode. If you never touch it, that works too.
