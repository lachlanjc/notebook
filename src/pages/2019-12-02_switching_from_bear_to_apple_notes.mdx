...
* When I want tomake notes on an article, instead of pasting the URL & typing up notes below it, I can use the Share extension to file a note when I save it, have a rich link preview, then annotate a preserved copy of the article with my Apple Pencil, and have the entire package saved & shareable.
