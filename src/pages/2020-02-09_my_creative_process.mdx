...
*(According, coincidentally, to the computer screen of my neighbor at the library, divergence & convergence is a [calculus concept](http://tutorial.math.lamar.edu/Classes/CalcII/ConvergenceOfSeries.aspx) as well. If I hadn’t [gotten a C+ in calculus](https://notebook.lachlanjc.me/2020-02-09_how_to_survive_high_school/), I’d make some “interesting connection” here.)*

## In action

In December, I needed to design myself some business cards. The design started simply, drawing color/style from my [Notebook](https://notebook.lachlanjc.me) blog site. But it was obviously too boring, so I started diverging with different layouts and color palettes (credit to [@byalicelee](https://twitter.com/byalicelee)). Over time, I found the elements I liked more, and converged back to the final design (highlighted in red). You can see this structure in my [Figma](http://figma.com) artboards:
...
*(Cross-posted from [my IMA blog](https://ima.lachlanjc.me/2020-02-09_bit_week_2_creative_process/).)*
