...
const theme = merge(base, {
  ...
  fonts: {
    body: 'Whyte, "Whyte Arial Fallback", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    heading:
      'WhyteInktrap, "WhyteInktrap Arial Fallback", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
