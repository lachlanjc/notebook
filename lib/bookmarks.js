...
export const cityPages = {
  barcelona: { id: 'zrb90zvepukfdg', title: 'Barcelona' },
  berlin: { id: 'CiDzkGmGUvpvLx', title: 'Berlin' },
  copenhagen: { id: 'O5YFRmh9TmEL7f', title: 'Copenhagen' },
  london: { id: 'WPQi78ktXUAUKA', title: 'London' },
  'new-york-city': { id: 'oQNlyDVj1Uy42C', title: 'New York City' },
  'san-francisco': { id: 'dDG3j3RaclpYCa', title: 'San Francisco' },
}
    ...
    .map(({ id, content, type, rawProperties, style: rawStyle }) => {
      const properties =
        typeof rawProperties === 'string' && rawProperties.startsWith('{')
          ...
          : {}
      if (properties.smartLinkData) {
        properties.smartLinkData = JSON.parse(properties.smartLinkData)
      }
      const style =
